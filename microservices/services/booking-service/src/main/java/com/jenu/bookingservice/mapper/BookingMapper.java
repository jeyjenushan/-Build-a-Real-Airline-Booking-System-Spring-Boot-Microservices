...
public class BookingMapper {
    ...
    toResponse(Booking booking, PaymentDTO paymentDTO, FareResponse fareResponse,
...
//                flight details
                ...
                .flightName(flightResponse != null && flightResponse.getArrivalAirport() != null && flightResponse.getDepartureAirport() != null
                        ? flightResponse.getDepartureAirport().getCityResponse().getName() + " - " + flightResponse.getArrivalAirport().getCityResponse().getName()
                        : null)
