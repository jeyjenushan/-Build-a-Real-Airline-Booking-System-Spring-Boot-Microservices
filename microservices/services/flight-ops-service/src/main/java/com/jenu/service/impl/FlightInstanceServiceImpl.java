...
public class FlightInstanceServiceImpl implements FlightInstanceService {
    ...
    @Override
    public FlightInstanceResponse updateFlightInstance(Long id, FlightInstanceRequest flightInstanceRequest) throws Exception {
        FlightInstance existingFlightInstance=flightInstanceRepository
                .findById(id)
                .orElseThrow(
                        ()->new Exception("Flight instance is not found")
                );
