...
public class FareMapper {
    ...
    public static FareResponse toResponse(Fare fare) {
        ...
        return FareResponse.builder()
                ...
                .advancedSeatSelection(fare.getSeatBenefits() != null ? fare.getSeatBenefits().getAdvanceSeatSelection() : false)
                ...
                .freeDataChange(fare.getFlexibilityBenefits() != null ? fare.getFlexibilityBenefits().getFreeDateChange() : false)
